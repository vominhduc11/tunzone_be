...
public class Reseller extends Account {
    ...
    @Column(name = "coor", nullable = false, unique = true, length = 50)
    private String coor;
    ...
    @Column(name = "opening_hours", nullable = false, unique = false)
    private String opening_hours;

    @Column(name = "rating", nullable = false, unique = false)
    private int rating;

    @Column(name = "services", nullable = false, columnDefinition = "TEXT[]", unique = false)
